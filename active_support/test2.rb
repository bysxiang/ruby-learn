...
class Module
  ...
  def qualified_const_get(path)
    ...
    QualifiedConstUtils.names(path).inject(self) do |mod, name|
      ...
      str = mod.const_get(name)
      puts "str: #{str}, #{str.class}"
      str
...
#p QualifiedConstUtils.names("Java::Paa")

p Java.qualified_const_get("Java::Paa")
p Java.const_get("Java")
p Object.const_get("Java")