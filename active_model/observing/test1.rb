  ...
  class Observer
    ...
    class << self
      ...
      def observe(*models)
        ...
        redefine_method(:observed_classes) { puts "进入这里"; models }
      end
...
class DefcOb < ActiveModel::Observer
  observe :defc
end

p AbcObserver.observed_classes

p DefcOb.observed_classes

p DefcOb.instance().observed_classes
