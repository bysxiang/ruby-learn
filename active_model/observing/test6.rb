...
class AddObserver < ActiveModel::Observer
  observe :abc
end

Abc.observers = :abc_observer, :add_observer
...
class DefcObserver < ActiveModel::Observer
end

Defc.observers = :defc_observer
Defc.instantiate_observers

abc = Abc.new

p Abc.observers

Abc.observers.disable :add_observer

p Abc.observers.disabled_for?(AbcObserver.instance)

p Defc.observers.disabled_for?(AbcObserver.instance)