  ...
  module AttributeMethods
      ...
      def define_attribute_method(attr_name)
        attribute_method_matchers.each do |matcher|
          ...
          unless instance_method_already_implemented?(method_name)
            ...
            respond_to_result = respond_to?(generate_method, true)

            puts "输出respond_to_result: #{respond_to_result}"

            if respond_to_result
              send(generate_method, attr_name)
            else
              puts "进入define_attribute_method"
    ...
    private
      def match_attribute_method?(method_name)
        ...
        puts "输出match_attribute_method? : #{match}"
...
class Abc
  ...
  #define_attribute_methods [:name3]
