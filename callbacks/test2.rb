...
class Occ
  def before_save(caller)
    puts "before_save, #{caller}"
  end

  def before_save2(caller)
    puts "before_save2, #{caller}"
  end
...
class Abc
  ...
  define_callbacks :save, scope: ["before_save2"]
  set_callback :save, Occ.new
